    ...
    <div className="bg-slate-900/40 border border-slate-800 p-4 rounded-3xl flex flex-col lg:flex-row gap-6 items-end lg:items-center">
      ...
      <div className="flex items-center gap-6 shrink-0 h-10">
        <label className="flex items-center gap-3 cursor-pointer group">
          ...
          <span className="text-[10px] font-black text-slate-400 uppercase tracking-widest group-hover:text-white transition-colors">Todo el histórico</span>
        </label>
        ...
        <button 
          ...
          className={cn(
            "h-full px-6 rounded-xl font-black text-[10px] uppercase tracking-widest transition-all flex items-center gap-2 shadow-lg",
        ...
        {showSuccess && (
          ...
          >
            ...
            <div className="flex flex-col">
              <span className="text-sm font-black uppercase tracking-tight">¡Reporte Generado!</span>
