          ...
          <table className="w-full text-left">
            <thead>
              <tr className="bg-slate-900/60 border-b border-slate-800/50 sticky top-0 z-10">
                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-widest">Temporalidad</th>
                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-widest">Operación</th>
                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-widest px-8">Operador</th>
                <th className="px-8 py-5 text-[10px] font-black text-slate-500 uppercase tracking-widest">Datos de Trazabilidad</th>
              </tr>
            </thead>
                ...
                <tr>
                   <td colSpan={4} className="py-20 text-center">
                      <div className="flex flex-col items-center gap-4">
                        ...
                        <span className="text-xs font-black text-slate-600 uppercase tracking-widest">Cargando Línea de Tiempo...</span>
                      </div>
                   </td>
                </tr>
                  ...
                  <tr key={log.id} className="group hover:bg-white/[0.02] transition-colors border-b border-slate-900/40 last:border-0">
                    <td className="px-8 py-5">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[10px] font-bold text-slate-500 mt-0.5 uppercase tracking-tighter">{new Date(log.created_at).toLocaleDateString()}</span>
                      </div>
                    </td>
                    <td className="px-8 py-5">
                       <span className={cn(
                         "text-[10px] font-black uppercase tracking-widest px-2.5 py-1.5 rounded-lg border flex items-center gap-2 w-fit",
