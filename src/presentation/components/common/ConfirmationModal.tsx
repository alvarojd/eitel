            ...
            <div className="p-8">
              <div className="flex items-center gap-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-slate-500 uppercase tracking-widest font-bold mt-0.5">Acción administrativa requerida</p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                <button
                  ...
                  disabled={isLoading}
                  className={cn(
                    "w-full py-4 rounded-2xl font-black text-sm uppercase tracking-widest transition-all active:scale-95 flex items-center justify-center gap-3",
                ...
                <button
                  onClick={onClose}
                  disabled={isLoading}
                  className="w-full py-4 text-slate-500 hover:text-white font-black text-sm uppercase tracking-widest transition-colors"
                >
                  {cancelLabel}
                </button>
              </div>
