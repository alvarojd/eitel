      ...
      <div className="bg-slate-950/50 p-6 rounded-3xl border border-slate-800/60 shadow-inner relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 relative z-10">
          <div className="flex items-center gap-5">
             ...
             <div>
                <p className="text-xs font-black text-slate-600 uppercase tracking-widest mb-1">Usuario en Sesión</p>
          ...
          <div className="px-5 py-2.5 rounded-2xl border bg-slate-900 shadow-xl flex items-center gap-3">
             ...
             <span className={user?.role === 'ADMIN' ? 'text-amber-500 font-black text-xs uppercase tracking-widest' : 'text-sky-400 font-black text-xs uppercase tracking-widest'}>
