...
export function SystemTab() {
 ...
 <span className="text-xs font-black text-slate-600 tracking-widest">Recuperando Configuración...</span>
 </div>
 );
 }
 ...
 <label className="text-[10px] font-black text-slate-500 tracking-widest ml-1">Nombre Comercial / Título</label>
...
"p-4 rounded-2xl flex items-center gap-3 border",
 ...
 <h4 className="text-sm font-black text-white tracking-wider mb-1">Nota de Seguridad</h4>
 ...
 <p className="text-[10px] font-black text-slate-500 tracking-widest">{item.label}</p>
 ...
 <div>
 <p className="text-xs font-black text-white tracking-widest">LoRaWAN Webhook</p>
 <p className="text-[10px] font-mono text-sky-400 mt-0.5">/api/webhook</p>
 </div>
 </div>
 <div className="flex items-center gap-2">
 <div className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse" />
 <span className="text-[10px] font-black text-emerald-500 tracking-widest">Activo</span>
 </div>
 </div>
 </div>
