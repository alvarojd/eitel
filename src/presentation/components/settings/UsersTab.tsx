...
"px-6 py-3 rounded-2xl text-sm font-black transition-all flex items-center justify-center gap-2 shadow-xl active:scale-95",
 ...
 <label className="text-[10px] font-black text-slate-500 tracking-widest ml-1">Nombre de Usuario</label>
 <input 
 required
 value={newUsername}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-500 tracking-widest ml-1">Contraseña Inicial</label>
 <input 
 required
 type="password"
 value={newPassword}
 ...
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-500 tracking-widest ml-1">Nivel de Acceso</label>
 <select 
 value={newRole}
 ...
 <th className="px-8 py-5 text-[10px] font-black text-slate-500 tracking-widest">Identidad</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-500 tracking-widest">Rol</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-500 tracking-widest hidden lg:table-cell">Antigüedad</th>
 <th className="px-8 py-5 text-[10px] font-black text-slate-500 tracking-widest text-right">Acciones</th>
 </tr>
 </thead>
 ...
 <span className="text-xs font-black text-slate-600 tracking-widest">Recuperando Directorio...</span>
 </div>
 </td>
 </tr>
...
"w-10 h-10 rounded-xl border flex items-center justify-center font-black text-xs relative overflow-hidden",
 ...
 {u.id === currentUser?.id && (
 <span className="bg-sky-500 text-white text-[9px] px-1.5 py-0.5 rounded-md font-black tracking-wider">Tú</span>
 )}
 </div>
