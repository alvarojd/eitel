            ...
            return (
              ...
              >
                ...
                <div className="flex items-start justify-between gap-4 mb-6 relative">
                  ...
                  <div className={cn(
                    "text-[9px] font-black uppercase tracking-widest px-2 py-1 rounded-lg border flex items-center gap-1.5 shrink-0",
                ...
                <div className="bg-slate-950/80 rounded-[1.5rem] p-4 border border-slate-800/50 space-y-4 shadow-inner relative z-10">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-slate-900/40 p-2.5 rounded-xl border border-slate-800/40 flex flex-col gap-1">
                      <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">RSSI</span>
                    ...
                    <div className="bg-slate-900/40 p-2.5 rounded-xl border border-slate-800/40 flex flex-col gap-1">
                      <span className="text-[9px] font-black text-slate-600 uppercase tracking-widest">SNR</span>
                  ...
                  <div className="flex justify-between items-center text-[10px] font-bold text-slate-500 pt-1 border-t border-slate-800/40">
                    <div className="flex items-center gap-2">
                      <MapPin size={12} />
                      <span className="uppercase tracking-widest">Gateway</span>
                    </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                       ...
                       <div className="flex flex-col">
                         ...
                         <span className="text-[8px] font-bold text-slate-600 uppercase mt-0.5">Energía</span>
                       </div>
                    </div>
                    ...
                    <div className="flex items-center gap-2">
                       ...
                       <div className="flex flex-col">
                         ...
                         <span className="text-[8px] font-bold text-slate-600 uppercase mt-0.5">Status</span>
                       </div>
                    </div>
                  </div>
