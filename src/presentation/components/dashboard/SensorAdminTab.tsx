...
const MapPicker = dynamic(() => import('../common/MapPicker').then(mod => mod.MapPicker), { 
 ...
 <p className="text-xs font-black text-slate-500 tracking-widest">Cargando Mapa...</p>
 </div>
 </div>
 )
});
...
export function SensorAdminTab() {
 ...
 <p className="text-xs font-black text-sky-400 tracking-widest">Nota Administrativa</p>
 ...
 <h3 className="text-[10px] font-black text-slate-500 tracking-widest flex items-center gap-2 ml-1">
 <RefreshCcw size={12} /> Configuración Base
 </h3>
 
 <div className="bg-slate-950/40 border border-slate-800 p-5 rounded-3xl space-y-6">
 <div className="space-y-2">
 <label className="text-[10px] font-black text-slate-600 tracking-widest ml-1">Nombre Amigable</label>
 <input 
 value={name}
 ...
 <label className="text-[10px] font-black text-slate-600 tracking-widest ml-1">Geolocalización</label>
 <button 
 onClick={() => setShowMap(true)}
 className="text-[9px] font-black text-sky-500 hover:text-sky-400 transition-colors flex items-center gap-1.5"
 >
 ...
 <h3 className="text-[10px] font-black text-rose-500/70 tracking-widest flex items-center gap-2 ml-1">
 ...
 <div>
 <p className="text-xs font-black text-rose-500">Reiniciar Datos</p>
 ...
 disabled={isDeleting}
 className="w-full py-3 border border-rose-500/20 hover:bg-rose-500/10 text-rose-500 font-black text-[10px] tracking-widest rounded-xl transition-all mt-2"
 >
 ...
 <div>
 <p className="text-xs font-black text-rose-500">Eliminar Dispositivo</p>
 ...
 className="w-full py-4 bg-rose-500/10 hover:bg-rose-500/20 text-rose-500 border border-rose-500/20 font-black text-xs tracking-widest rounded-2xl transition-all"
 >
 ...
 disabled={isDeleting}
 className="w-full py-4 bg-rose-600 hover:bg-rose-500 text-white font-black text-xs tracking-widest rounded-2xl shadow-xl shadow-rose-900/20 transition-all active:scale-95 flex items-center justify-center gap-2"
 >
 ...
 className="w-full py-2 text-[10px] font-black text-slate-600 hover:text-slate-400 tracking-widest transition-colors"
 >
 No, Cancelar
 </button>
 </div>
